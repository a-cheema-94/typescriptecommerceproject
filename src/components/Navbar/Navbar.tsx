...
const Navbar = () => {
  ...
  // todo => attempt to cut re - renders by moving state from global context only to relevant components in the component tree => in this case openCart since it should only affect the CartSideBar.
