...
const CategoriesBar = () => {
  ...
  const firstLetterCapital = (str: string): string =>
  ...
  return (
    <div className="flex flex-wrap justify-start items-center bg-slate-50 dark:bg-slate-600 py-2 select-none dark:text-white">
      ...
      <Link to="/">
        <h2
          className="cursor-pointer hover:bg-black/[.1] rounded p-2 ml-3"
      ...
      >
        <svg
          className="w-6 h-6 text-orange-500 hover:text-orange-700 cursor-pointer"
          aria-hidden="true"
